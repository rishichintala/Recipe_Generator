...
// /* Allow common English clusters like “sch”, “str”, “spr”, “spl”, “scr”, “shr”.
//    Negative look‑ahead skips those, so they DON’T trigger the gibberish block. */
...
// /* Relaxed vowel rule:
//    words ≥ 5 letters must have ≥ 2 vowels (4‑letter foods like “milk” now pass) */
...
//       setMsg("❌ Please enter a real ingredient (letters only).");
//       clearMsg();
...
//             Add ingredients one at a time by typing and pressing{" "}
//             <strong>Enter</strong>. You can remove any by clicking the × icon.
//           </div>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <section className="bg-white rounded-xl shadow p-6 mb-10">
          ...
          <div className="bg-blue-50 text-blue-800 px-3 py-2 rounded text-sm mb-3">
            ...
            <strong>Enter</strong>. Remove any by clicking ×.
          </div>
